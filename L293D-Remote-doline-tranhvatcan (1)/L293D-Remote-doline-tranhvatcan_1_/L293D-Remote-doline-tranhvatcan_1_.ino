...
int lechA = +45;          //bù lệch tốc độ bánh trái
...
void setup() {  
    ...
    myservo.write(75);         //Chỉnh lại góc quay SG90: 85,95,105,... sao cho cảm biến siêu âm thẳng với xe
    delay(1000);
    // distance = readPing();
    // delay(100);
    // distance = readPing();
...
void loop(){
      ...
      Serial.print(data);
        ...
        Serial.println("Bluetooth not avaiable: ");
        Serial.print(data);
      }
      ...
      if(data == '1') {temp = F;  delay(100);}
      else if(data == '2') {temp = B;   delay(100);}
      else if(data == '3') {temp = L;  delay(100);}
      else if(data == '4') {temp = R;  delay(100);}
      else if(data == '5') {temp = track;  delay(100);}
      else if(data == '0') {temp = S;  delay(100);}

      // if((strstr(receivedData.c_str(), "up") != NULL) || (strstr(data.c_str(), "up") != NULL)) {temp = F; delay(100);}
      // else if((strstr(receivedData.c_str(), "down") != NULL) || (strstr(data.c_str(), "down") != NULL)) {temp = B; delay(100);}
      // else if((strstr(receivedData.c_str(), "left") != NULL) || (strstr(data.c_str(), "left")!= NULL)) {temp = L; delay(100);}
      // else if((strstr(receivedData.c_str(), "right") != NULL) || (strstr(data.c_str(), "right")!= NULL)) {temp = R; delay(100);}
      // else if((strstr(receivedData.c_str(), "stop") != NULL) || (strstr(data.c_str(), "stop")!= NULL)) {temp = S; delay(100);}
      // else if((strstr(receivedData.c_str(), "track") != NULL) || (strstr(data.c_str(), "track")!= NULL)) {temp = track; delay(100);}
